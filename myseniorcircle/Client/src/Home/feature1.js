...
{
   return (<div style={{backgroundColor:"#ddeeff",alignItems:"center"}}>
   {/* e8f1fc */}
    <Row className="m-0 p-0">
        ...
        {props.winWidth>767&&<Col xs={12} sm={12} md={5} lg={5} className="m-0 p-0" style={{display:"flex",flexDirection:"row-reverse"}}><img className="fea1_img" src={Feature1Img}/></Col>}
    </Row>
   </div>); 
}
