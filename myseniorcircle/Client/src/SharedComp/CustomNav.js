  ...
  {props.winWidth>750&&<div className="nav_row1">
    ...
    <div style={{display:"flex",flexDirection:"row-reverse"}}>
      <div className={"SideNav "+(Toggle===true?"Nav1":"Nav2")} style={{height:props.winHeight}}>
        ...
        {!user&&<Link to="/login" style={{textDecoration:"none"}}><div className="nav_options2" onClick={()=>setToggle(false)}>Login</div></Link>}
        {!user&&<Link to="/signup" style={{textDecoration:"none"}}><div className="nav_options2" onClick={()=>setToggle(false)}>Sign up</div></Link>}
